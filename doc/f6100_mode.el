...
(defconst f6100-font-lock-keywords-1
  (list
   '("\\(crash\\|nop\\|and\\|or\\|xor\\|not\\|rol\\|asr\\|add\\|sub\\|cmp\\|neg\\|mov\\|ldr\\|str\\|ldb\\|stb\\|lc\\|ll\\|swp\\|addi\\|cmpi\\|bz\\|bnz\\|bs\\|[^a-z]b[^a-z]\\|stat\\|check\\|mode\\|fork\\|write\\)" . 'f6100-keyword-face)
